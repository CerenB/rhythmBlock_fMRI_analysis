...
[targetSNR, targetPhase, targetSNRsigned, tSNR] = calcSNRmv6(avgPattern, ...
                                                             avgrawPattern, ...
                                                             TF, BinSize, ...
                                                             Thresh, histBin);
...
function opt = getSpecificBoldFiles(opt)
    ...
    funcMaskFileName = fullfile(subFuncDataDir, ...
                                ['meanasub-pil001_ses-001_task-,', ...
                                 opt.taskName, '_run-001_bold.nii']);

    if strcmp(opt.space, 'individual')
        funcMaskFileName = fullfile(subFuncDataDir, ...
                                    ['meanuasub-pil001_ses-001_task-', ...
                                     opt.taskName, '_run-001_bold.nii']);
    end
